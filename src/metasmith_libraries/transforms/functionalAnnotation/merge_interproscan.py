...
chunk_desc  = model.AddRequirement(lib.GetType("annotation::interproscan_descriptions_chunk"), parents={parent_orfs})
merged      = model.AddProduct(lib.GetType("annotation::interproscan_results"))
merged_desc = model.AddProduct(lib.GetType("annotation::interproscan_descriptions"))

...
chunk_desc  = model.AddRequirement(lib.GetType("annotation::diamond_uniref50_descriptions_chunk"), parents={parent_orfs})
merged      = model.AddProduct(lib.GetType("annotation::diamond_uniref50_results"))
merged_desc = model.AddProduct(lib.GetType("annotation::diamond_uniref50_descriptions"))
...
# one search, so the same cluster is described identically in as many chunks as
# hit it.
